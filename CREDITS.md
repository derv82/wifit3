...
vendor list opens with our deepest personal thanks (below), metrics aside. A name with no
linked GitHub handle means the kernel commits carry none (common for vendor `@realtek.com`
authors and pre-GitHub-era contributors).
