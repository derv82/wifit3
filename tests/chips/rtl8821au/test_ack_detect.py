"""rtl8821au TX-ACK detection: the RX tap that counts the AP's link-layer ACKs to a MAC we
...
(RXFLTMAP1 bit13 is opened by enable_ack_detect)."""
import time
...
def _driver() -> drv.RTL8821AUDriver:
