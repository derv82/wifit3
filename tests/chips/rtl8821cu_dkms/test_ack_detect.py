...
set_opmode_monitor accept-alls RXFLTMAP1, so detection is a pure software flag; the tap lives
in _dispatch (raw frames), before the parser drops the ACK control frame."""
import struct
import time
