"""Decode the aireplay-ng TX frames out of an ar9271_v2 cold-boot capture, in layers.
    ...
    uv run python scripts/ar9271_v2/dump_tx.py [capture-1|capture-2|capture-3]
...
Pair with ``scripts/pcap_slicer.py <logs>/main.log <pcap>`` to see which phase (aireplay-ng
