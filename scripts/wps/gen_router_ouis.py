...
Usage:
    uv run python scripts/wps/gen_router_ouis.py            # download a fresh registry
    uv run python scripts/wps/gen_router_ouis.py oui.csv    # use a local IEEE csv
"""
...
def main(source: str | None = None) -> None:
    ...
    header = (
        ...
        "GENERATED by scripts/wps/gen_router_ouis.py from the IEEE OUI registry\n"
