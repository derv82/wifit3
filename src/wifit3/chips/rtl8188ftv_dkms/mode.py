...
def set_station_opmode(t, st: dict) -> None:
    bcn = t.read8(0x550) | BIT(4)
    t.write8(0x550, bcn)
    msr = t.read8(0x102) & 0x0C
    t.write8(0x102, msr | 0x02)
    t.write8(0x422, st["fw_hw_tx_q_ctrl"] & ~BIT(6))
    t.write8(0x541, 0x64)
    t.write8(0x542, st["reg542"] & ~BIT(0))
    st["fw_hw_tx_q_ctrl"] &= ~BIT(6)
    st["reg542"] &= ~BIT(0)
    t.write8(0x550, BIT(4) | BIT(3) | BIT(0))
