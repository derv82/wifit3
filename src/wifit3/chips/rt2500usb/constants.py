...
RT2500USB_DEVICE_TABLE: list[tuple[int, int, str]] = [
    (0x0b05, 0x1706, "RT2500USB (ASUS)"),
    (0x0b05, 0x1707, "RT2500USB (ASUS)"),
    (0x050d, 0x7050, "RT2500USB (Belkin F5D7050A v2.x)"),
    (0x050d, 0x7051, "RT2500USB (Belkin)"),
    (0x13b1, 0x000d, "RT2500USB (Cisco/Linksys)"),
    (0x13b1, 0x0011, "RT2500USB (Cisco/Linksys)"),
    (0x13b1, 0x001a, "RT2500USB (Cisco/Linksys)"),
    (0x14b2, 0x3c02, "RT2500USB (Conceptronic)"),
    (0x2001, 0x3c00, "RT2500USB (D-Link)"),
    (0x1044, 0x8001, "RT2500USB (Gigabyte)"),
    (0x1044, 0x8007, "RT2500USB (Gigabyte)"),
    (0x06f8, 0xe000, "RT2500USB (Hercules)"),
    (0x0411, 0x005e, "RT2500USB (Melco/Buffalo)"),
    (0x0411, 0x0066, "RT2500USB (Melco/Buffalo)"),
    (0x0411, 0x0067, "RT2500USB (Melco/Buffalo)"),
    (0x0411, 0x008b, "RT2500USB (Buffalo Nintendo Wi-Fi USB Connector)"),
    (0x0411, 0x0097, "RT2500USB (Melco/Buffalo)"),
    (0x0db0, 0x6861, "RT2500USB (MSI)"),
    (0x0db0, 0x6865, "RT2500USB (MSI)"),
    (0x0db0, 0x6869, "RT2500USB (MSI)"),
    (0x148f, 0x1706, "RT2500USB (Ralink)"),
    (0x148f, 0x2570, "RT2500USB (Ralink)"),
    (0x148f, 0x9020, "RT2500USB (Ralink)"),
    (0x079b, 0x004b, "RT2500USB (Sagem)"),
    (0x0681, 0x3c06, "RT2500USB (Siemens)"),
    (0x0707, 0xee13, "RT2500USB (SMC)"),
    (0x114b, 0x0110, "RT2500USB (Spairon)"),
    (0x0769, 0x11f3, "RT2500USB (SureCom)"),
    (0x0eb0, 0x9020, "RT2500USB (Trust)"),
    (0x0f88, 0x3012, "RT2500USB (VTech)"),
    (0x5a57, 0x0260, "RT2500USB (Zinwell)"),
]
