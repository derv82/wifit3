...
RT2500USB_DEVICE_TABLE: list[tuple[int, int, str]] = [
    (0x0b05, 0x1706, "ASUS"),
    (0x0b05, 0x1707, "ASUS"),
    (0x050d, 0x7050, "Belkin F5D7050A v2.x"),
    (0x050d, 0x7051, "Belkin"),
    (0x13b1, 0x000d, "Cisco/Linksys"),
    (0x13b1, 0x0011, "Cisco/Linksys"),
    (0x13b1, 0x001a, "Cisco/Linksys"),
    (0x14b2, 0x3c02, "Conceptronic"),
    (0x2001, 0x3c00, "D-Link"),
    (0x1044, 0x8001, "Gigabyte"),
    (0x1044, 0x8007, "Gigabyte"),
    (0x06f8, 0xe000, "Hercules"),
    (0x0411, 0x005e, "Melco/Buffalo"),
    (0x0411, 0x0066, "Melco/Buffalo"),
    (0x0411, 0x0067, "Melco/Buffalo"),
    (0x0411, 0x008b, "Buffalo Nintendo Wi-Fi USB Connector"),
    (0x0411, 0x0097, "Melco/Buffalo"),
    (0x0db0, 0x6861, "MSI"),
    (0x0db0, 0x6865, "MSI"),
    (0x0db0, 0x6869, "MSI"),
    ...
    (0x079b, 0x004b, "Sagem"),
    (0x0681, 0x3c06, "Siemens"),
    (0x0707, 0xee13, "SMC"),
    (0x114b, 0x0110, "Spairon"),
    (0x0769, 0x11f3, "SureCom"),
    (0x0eb0, 0x9020, "Trust"),
    (0x0f88, 0x3012, "VTech"),
