...
capture by ``scripts/porting/verify_pcap.py rt5372`` (the operational gate).
...
class RT5372Driver(Driver):
    SUPPORTED_IDS: ClassVar[List[DeviceID]] = [
        DeviceID(_VID_RALINK, _PID_RT5372, "RT5372", product_name="Panda PAU05/06"),
    ]
    ...
    def _bringup(self) -> None:
        ...
        ``scripts/porting/verify_pcap.py rt5372`` ``_walk_init`` (the gate replays it). The leading
