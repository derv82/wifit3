...
# This card reports rt=RT5392 (the silicon id); the 148f:5372 USB PID is the
# marketing SKU. RT5390 is the 1T1R sibling that shares init_bbp_53xx /
# init_rfcsr (the rfcsr table + RFCSR50 differ) / config_channel_rf53xx.
RT5390 = 0x5390
RT5392 = 0x5392

# chipset revisions [SRC rt2800.h:87-89] — RT5390F gates the per-channel
...
class ChipInfo:
    ...
    (``rt2x00_rt`` / ``rt2x00_rt_rev_lt`` / ``rt2x00_rt_rev_gte``). PAU05/PAU06
    report rt=RT5392, rev=0x0223."""
