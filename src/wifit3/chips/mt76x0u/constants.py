...
USB_IDS_MT76X0U: list[tuple[int, int, str]] = [
    ...
    (0x13B1, 0x003E, "MediaTek MT7610U (Linksys AE6000)"),
    (0x0E8D, 0x7610, "MediaTek MT7610U (Alfa AWUS036ACHM)"),
    (0x7392, 0xa711, "MediaTek MT7610U (Edimax 7711mac)"),
    (0x7392, 0xb711, "MediaTek MT7610U (Edimax / Elecom)"),
    (0x148F, 0x761a, "MediaTek MT7610U (TP-Link TL-WDN5200)"),
    (0x148F, 0x760a, "MediaTek MT7610U (TP-Link)"),
    (0x0B05, 0x17d1, "MediaTek MT7610U (Asus USB-AC51)"),
    (0x0B05, 0x17db, "MediaTek MT7610U (Asus USB-AC50)"),
    (0x0DF6, 0x0075, "MediaTek MT7610U (Sitecom WLA-3100)"),
    (0x2019, 0xab31, "MediaTek MT7610U (Planex GW-450D)"),
    (0x2001, 0x3d02, "MediaTek MT7610U (D-Link DWA-171 rev B1)"),
    (0x0586, 0x3425, "MediaTek MT7610U (Zyxel NWD6505)"),
    (0x07B8, 0x7610, "MediaTek MT7610U (AboCom AU7212)"),
    (0x04BB, 0x0951, "MediaTek MT7610U (I-O DATA WN-AC433UK)"),
    (0x057C, 0x8502, "MediaTek MT7610U (AVM FRITZ!WLAN USB Stick AC 430)"),
    (0x293C, 0x5702, "MediaTek MT7610U (Comcast Xfinity KXW02AAA)"),
    (0x20F4, 0x806b, "MediaTek MT7610U (TRENDnet TEW-806UBH)"),
    (0x7392, 0xc711, "MediaTek MT7610U (Devolo Wifi ac Stick)"),
    (0x0DF6, 0x0079, "MediaTek MT7610U (Sitecom Europe ac Stick)"),
    (0x2357, 0x0123, "MediaTek MT7610U (TP-Link T2UHP_US_v1)"),
    (0x2357, 0x010b, "MediaTek MT7610U (TP-Link T2UHP_UN_v1)"),
    (0x2357, 0x0105, "MediaTek MT7610U (TP-Link Archer T1U)"),
