...
USB_IDS_8822BU: tuple[tuple[int, int, str], ...] = (
    ...
    (0x2357, 0x012D, "RTL8822BU (TP-Link Archer T3U v1)"),
    ...
    (0x0B05, 0x184C, "RTL8822BU (ASUS U2)"),
