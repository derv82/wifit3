...
USB_IDS_8822BU: tuple[tuple[int, int, str], ...] = (
    ...
    (0x2357, 0x0138, "Realtek RTL8822BU (TP-Link Archer T3U Plus)"),
    (0x2357, 0x012D, "Realtek RTL8822BU (TP-Link Archer T3U v1)"),
    (0x2357, 0x0115, "Realtek RTL8822BU (TP-Link Archer T4U V3)"),
    (0x2357, 0x012E, "Realtek RTL8822BU (TP-Link)"),
    (0x2357, 0x0116, "Realtek RTL8822BU (TP-Link)"),
    (0x2357, 0x0117, "Realtek RTL8822BU (TP-Link)"),
    (0x0BDA, 0xB812, "Realtek RTL8822BU"),
    (0x0BDA, 0xB82C, "Realtek RTL8822BU"),
    (0x0BDA, 0xB81A, "Realtek RTL8822BU (default)"),
    (0x0B05, 0x1841, "Realtek RTL8822BU (ASUS USB-AC55 B1)"),
    (0x0B05, 0x184C, "Realtek RTL8822BU (ASUS U2)"),
    (0x0B05, 0x19AA, "Realtek RTL8822BU (ASUS USB-AC58 rev A1)"),
    (0x2001, 0x331E, "Realtek RTL8822BU (D-Link DWA-181)"),
    (0x2001, 0x331C, "Realtek RTL8822BU (D-Link DWA-182 D1)"),
    (0x13B1, 0x0043, "Realtek RTL8822BU (Linksys WUSB6400M)"),
    (0x13B1, 0x0045, "Realtek RTL8822BU (Linksys WUSB3600 v2)"),
    (0x0846, 0x9055, "Realtek RTL8822BU (Netgear A6150)"),
    (0x7392, 0xB822, "Realtek RTL8822BU (Edimax EW-7822ULC)"),
    (0x7392, 0xC822, "Realtek RTL8822BU (Edimax EW-7822UTC)"),
    (0x7392, 0xD822, "Realtek RTL8822BU (Edimax)"),
    (0x7392, 0xE822, "Realtek RTL8822BU (Edimax)"),
    (0x7392, 0xF822, "Realtek RTL8822BU (Edimax EW-7822UAD)"),
    (0x2C4E, 0x0107, "Realtek RTL8822BU (Mercusys MA30H)"),
    (0x2C4E, 0x010A, "Realtek RTL8822BU (Mercusys MA30N)"),
    (0x0411, 0x03D1, "Realtek RTL8822BU (BUFFALO WI-U2-866DM)"),
    (0x0411, 0x03D0, "Realtek RTL8822BU (BUFFALO WI-U3-866DHP)"),
)
